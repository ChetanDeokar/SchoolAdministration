...
class UserManager(BaseUserManager):
    ...
    def create_student(self, email, password, firstname, lastname):
        if not email:
    ...
    def create_teacher(self, email, password, firstname, lastname):
        if not email:
            raise ValueError('Users must have an email address')
    ...
    def create_head_master(self, email, password, firstname, lastname):
        if not email:
            raise ValueError('Users must have an email address')
